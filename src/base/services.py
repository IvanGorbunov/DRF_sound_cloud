...
def get_path_upload_avatar(instance, file):
    """
    Построение пути к файлу, formot: (media)/avatar/user_id/photo.jpg
    """
...
def get_path_upload_cover_album(instance, file):
    """
    Построение пути к файлу, formot: (media)/album/user_id/photo.jpg
    """
...
def get_path_upload_cover_playlist(instance, file):
    """
    Построение пути к файлу, formot: (media)/playlist/user_id/photo.jpg
    """
...
def get_path_upload_track(instance, file):
    """
    Построение пути к файлу, formot: (media)/track/user_id/photo.jpg
    """
