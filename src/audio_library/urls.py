...
urlpatterns = [
    ...
    path('track/<int:pk>/', views.TrackView.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'})),

    path('playlist/', views.PlayListView.as_view({'get': 'list', 'post': 'create'})),
    path('playlist/<int:pk>/', views.PlayListView.as_view({'get': 'retrieve', 'put': 'update', 'delete': 'destroy'})),
